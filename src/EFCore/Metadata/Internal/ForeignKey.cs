...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    public class ForeignKey : ConventionAnnotatable, IMutableForeignKey, IConventionForeignKey
    {
        ...
        /// </summary>
        [DebuggerStepThrough]
        IEnumerable<IMutableSkipNavigation> IMutableForeignKey.GetReferencingSkipNavigations()
        ...
        /// <inheritdoc />
        IEnumerable<IConventionSkipNavigation> IConventionForeignKey.GetReferencingSkipNavigations()
